...
<div class="content">
<h2>Behavioral Health Discharge Form</h2>
...
<!--Enter the form-->
<form:form method="POST" action="confirmBhnDischarge"> 
   ...
   <h3>Treatment</h3>
    ...
    <p>
      <label>Treatment Modality: </label>
        <form:select path="trtModality">
       	 	<form:options items="${trtModalityList}"/>
        </form:select>
    </p>

    <p>
      <label>Medication Assisted Treatment: </label>
        <form:select path="medicationAssisted">
       	 	<form:options items="${medicationAssistedList}"/>
        </form:select>
    </p>

    <p><label>Validated Treatment?</label> 
        <form:radiobutton path="validatedTrt" value="Y"/>Yes 
	 	<form:radiobutton path="validatedTrt" value="N"/>No
	</p>
