...
<div class="content">
<h2>Fresh Start Home Page</h2>
<p>This page is where you begin Fresh Start Program client data entry. The data collected on all the 
...
<h4>To enter an Intake form for a new client, please click <a href="fsIntake?inmate-num=0&program-id=1">Add Client</a></h4>
<h4>To edit a client's Intake Form:<br>
<form method="POST" action="fsIntake">
<input type="hidden" name="program-id" value="1"/>
...
<form method="POST" action="fsCaseManagement">
<input type="hidden" name="program-id" value="1"/>
<input name="inmate-num" id="inmateNum"/>
<input type="submit" id="inmatebutton" value="Submit">
</h4>
...
<form method="POST" action="fsDischarge">
<input type="hidden" name="program-id" value="1"/>
<input name="inmate-num" id="inmateNum"/>
<input type="submit" id="inmatebutton" value="Submit">
</h4>
